...
typedef enum {wan = 35, shan, jin1, jin2, hu, yu1, meng, xin, zang, qing, lu, yu2, su, zhe, ning, gui1, hei, ji1, liao, jin3, ji3, ming, gan, xiang, ee, yue, qiong, gan2, gui2, yun, chuan}CHINESE_PROVINCE;
...
void do_dets_sort(detection *dets, int total);
